...
// #define SENSOR_ZERO_PIM  27  // a sensor pin
...
// ----------------------------------------------------------------------------------------------------------------------------
//                                                                                       FUNCTION: COLLECT AND SEND SENSOR DATA

void sensorZero() {

  // example transmission to the rad command server
...
void setup() {
  ...
  */
  ...
  // attachInterrupt(SENSOR_ZERO_PIM, SENSOR_ZERO_ISR, FALLING);
